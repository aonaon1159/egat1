                    ...
                    while ($fetch = mysqli_fetch_array($query)) {
                        ?>
                            <tr class="w3-hover-green">
                                ...
                                <td><?php echo $fetch['b_phone']?></td>
                                <td><button class="btn btn-warning" data-toggle="modal" type="button" data-target="#update_modal<?php echo $fetch['b_id']?>"><span class="glyphicon glyphicon-edit"></span> Edit</button></td>
                                <td></td>
                            </tr>
                            <?php
                ...
                <form method="POST" action="save_board1.php" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-12">
                                <label><b>รูป</b></label>
                                <br>
                                <input type="file" id="b_image" name="b_image" id="b_image" required="required" value="Send File" />
                                <br></br>
                ...
                <form method="POST" action="update_query.php">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-12">
                                <label><b>รูป</b></label>
                                <br>
                                <input type="file" id="b_image" name="b_image" required="required" value="<?php echo $fetch['b_image']?>" />
                                <br></br>
                            <div class="form-group">
                                <label><b>ชื่อ</b></label>
                                <input type="text" id="b_name" name="b_name" class="form-control" required="required" value="<?php echo $fetch['b_name']?>" />
                            </div>
                            <div class="form-group">
                                <label><b>นามสกุล</b></label>
                                <input type="text" id="b_lname" name="b_lname" class="form-control" required="required" value="<?php echo $fetch['b_lname']?>" />
                            </div>
                            <label><b>ตำแหน่ง</b></label>  
                          <select type="gender" id="b_status" name="b_status" class="form-control">  
                               <option value="">-------</option>
                          ...
                          <br>
                            <div class="form-group">
                                <label><b>เบอร์โทรศัพท์</b></label>
                                <input type="text" id="b_phone" name="b_phone" class="form-control" required="required" value="<?php echo $fetch['b_phone']?>" />
                            </div>
                        </div>
                    </div>
                    <div style="clear:both;"></div>
