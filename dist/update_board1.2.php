<div class="modal fade" id="update_modal<?php echo $fetch['b_id']?>" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<form method="POST" action="update_query1.2.php">
				...
				<div class="modal-body">
					...
					<div class="col-md-12">
						...
						<div class="form-group">
							...
							<input type="text" name="b_lname" value="<?php echo $fetch['b_status']?>" class="form-control" required="required" />
						</div>
						<div class="form-group">
							<label><b>รายละเอียดเพิ่มเติม</b></label>
							<input type="text" name="b_lname" value="<?php echo $fetch['b_detail']?>" class="form-control" required="required" />
						</div>
					</div>
				</div>
